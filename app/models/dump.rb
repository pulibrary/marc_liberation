    ...
    class << self
      ...
      def diff_since_last
        ...
        Event.record do |event|
          ...
          break if earlier_bib_dump.nil? && later_bib_dump.nil?

          earlier_holding_dump, later_holding_dump = last_two_holding_id_dumps
          break if earlier_holding_dump.nil? && later_holding_dump.nil?
          ...
          dump_files = [
            ...
            later_holding_dump
          ].map { |d| d.dump_files.first }.compact
          ...
          break if earlier_bib_dump_file.nil? && later_bib_dump_file.nil?
          ...
          break if earlier_holding_dump_file.nil? && later_holding_dump_file.nil?
